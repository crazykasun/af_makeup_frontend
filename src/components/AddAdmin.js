            ...
            <div className="row">
                ...
                <div className="col-md-4 col-sm-12 col-lg-4">
                    <div className="form-signin mt-5">
                        ...
                        <h1 className="h3 mb-3 font-weight-normal mb-5">Create an Admin</h1>
                        ...
                        <button className="btn btn-lg btn-primary btn-block mt-4" type="submit" onClick={saveData}>Add
                            Admin
                        </button>
